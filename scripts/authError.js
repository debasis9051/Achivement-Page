let authErrors = {
    ...
    "auth/invalid-email": "The email address is badly formatted or the user does not have a correct email.",
    ...
    "auth/user-not-found": "There is no user record corresponding to this Email. The user may have been deleted or not yet registered.",
