let authErrors = {
    ...
    "auth/email-change-needs-verification": "Multi-factor users must always have a verified email. If issue persists, you can Sign in with Google",
    "auth/email-already-in-use": "The email address is already in use by another account. If issue persists, you can Sign in with Google",
    ...
    "auth/invalid-email": "The email address is badly formatted or the user does not have a correct email. If issue persists, you can Sign in with Google",
    ...
    "auth/account-exists-with-different-credential": "An account already exists with the same email address but different sign-in credentials. Sign in using Google associated with this email address.",
    ...
    "auth/user-not-found": "There is no user record corresponding to this Email. The user may have been deleted or not yet registered. ! Try Signing with google",
    "auth/user-disabled": "The user account has been disabled by an administrator.",
    "auth/user-mismatch": "The supplied credentials do not correspond to the previously signed in user.",
    "auth/user-signed-out": "User is no longer Signed in or Authorised",
    "auth/weak-password": "The password must be 6 characters long or more.",
    "user/no-photo" : "Please upload photo of the candidate!",
    "user/no-first-name" : "Please enter First name of the candidate!",
    "user/no-last-name" : "Please enter Last name of the candidate!",
    "user/no-stream" : "Please enter Stream of the candidate!",
    "user/no-package" : "Please enter Package of the candidate!",
    "user/no-year" : "Please enter  Year for the candidate!",
    "user/no-company" : "Please enter Company of the candidate!",
...
// console.log(authErrors["timeout"])
